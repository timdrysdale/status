...
func NewServeAPI(spec *loads.Document) *ServeAPI {
	return &ServeAPI{
		...
		StatusJumpsHandler: StatusJumpsHandlerFunc(func(params StatusJumpsParams, principal interface{}) middleware.Responder {
			return middleware.NotImplemented("operation StatusJumps has not yet been implemented")
		}),
...
func (o *ServeAPI) Validate() error {
	...
	if o.StatusJumpsHandler == nil {
		unregistered = append(unregistered, "StatusJumpsHandler")
	}
...
func (o *ServeAPI) initHandlerCache() {
	...
	o.handlers["GET"]["/jumps"] = NewStatusJumps(o.context, o.StatusJumpsHandler)
}
